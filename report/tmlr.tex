...
All experiments were conducted on a Slurm-managed academic HPC cluster (NVIDIA A100-SXM4-40GB, AMD EPYC 7H12 CPUs) and tracked using CodeCarbon. Appendix Table~\ref{tab:compute} summarises runtime and energy consumption. The total estimated carbon footprint was approximately 0.05~kg~CO$_2$, equivalent to driving 0.2~km in an average passenger vehicle. API costs for TTP via OpenRouter totalled \$12.57 USD across 393 requests (\~1.57M tokens).
