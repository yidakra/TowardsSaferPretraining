...
def save_partial_results(result, args):
    ...
    partial_output = {
        ...
        "samples": [
            ...
            for r in result.results[:args.sample_limit]
        ]
    }
...
def main():
    ...
    print(f"Loading HAVOC dataset from {args.data_path}...")
    try:
        loader = HAVOCLoader(args.data_path)
        samples = loader.load()
    ...
    # Evaluate
    print(f"Evaluating {args.model} on HAVOC...")
    result = None
    try:
    ...
    output_data = {
        ...
        "samples": [
            ...
            for r in result.results[:args.sample_limit]  # Save first N samples for inspection (configurable via --sample-limit)
        ]
    }
